let clubs = [
    {
        "name": "Century Club",
        "address": "Century Club Lane,<br> Vennala P.O.,<br> Kochi,<br> Kerala - 680028",
    ...
    },
    {
        ...
        "address": "Kothamangalam Club,<br> Kuthukuzhy P.O,<br> Kothamangalam - 686691,<br> Eranakulam Dist,",
    ...
    },
    {
        ...
        "address": "The United Club,<br> Xi/223A,<br> Mangalassery,<br> Koratty South - Thrissur 680308",
    ...
    },
    {
        ...
        "address": "Palghat Cosmopolitan Club<br> N.H. Bypass Road,<br> Palakkad<br> Kerala - 678 013,",
    ...
    {
        "name": "Engineers Club",
        "address": "33/588-B Chakkaraparambu,<br> Vennala,<br> Kochi - 682 028<br>Kerala,",
    ...
    },
    {
        ...
        "address": "No.375 A 375 B,<br> English Church Road,<br> Palakkad Ho,<br> Palakkad - 678001,<br> Near Income Tax,",
    ...
    {
        "name": "KH Club",
        "address": "Green City,<br> Kodenchery,<br> Thiruvambady Adivaram Road,<br> Kozhikode - 673580,",
    ...
    },
    {
        ...
        "address": "Vazhappally Chira,<br> Changanacherry,<br> Kottayam,<br> Kerala - 686103,",
    ...
    {
        "name": "RamaVarma Club",
        "address": "Mo Ward,<br> Alapuzha Hospital,<br> Alappuzha - 688001,<br> Old Medical Clg,",
    ...
    {
        "name": "Bekal Club",
        "address": "Padannakad,<br> Near Railway Gate,<br> Kanhangad,<br> Kasargod,<br> Kerala - 671328,",
...
function loadData() {
    ...
    const searchResults = clubs.filter(club => club.name.toLocaleLowerCase().includes(findInput.value.toLocaleLowerCase()));
    document.querySelector("#search-results-count").innerText = (searchResults.length);
